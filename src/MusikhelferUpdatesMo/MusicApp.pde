...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//CONSOLIDATION MARKERS FOR ETHAN (more under Note class) -Mo
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
void mouseReleased() {
  ...
  //Mo Spiegel 3B
  //-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  //ADDED MORE HARM BUTTON FUNCTIONALITY (THIS ENTIRE FOR LOOP)
  //-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  if (modeTog==3&&firstSwitch==true) {
    ...
    //-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    //ADDED MORE INPUT LOGIC (THIS ENTIRE ELSE-IF CHAIN)
    //-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    if ( notes.size()-1 != 0) {
